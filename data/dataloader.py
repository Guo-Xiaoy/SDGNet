...
from data import ThreeDMatch, Kitti, MVP_RG, CustomData,CustomDataForTest
...
def get_dataset(dataset_name, config):
    assert dataset_name in ['threedmatch', 'kitti', 'mvp_rg','customdata']
    if dataset_name == 'threedmatch':
        ...
        train_dataset = CustomData(root=config.root,
                                    split='train',
                                    aug=True,
                                    overlap_radius=config.overlap_radius)
        val_dataset = CustomData(root=config.root,
                                  split='val',
                                  aug=True,
                                  overlap_radius=config.overlap_radius)
        test_dataset = CustomDataForTest(root=config.root,
                                  split='test',
                                  aug=True,
                                  overlap_radius=config.overlap_radius)
