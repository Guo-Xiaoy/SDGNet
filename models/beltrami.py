...
from models.normalize import GCNAdjNorm
...
from models.utils import get_rw_adj
...
class ODEFuncTransformerAtt(ODEFunc):
  ...
  def multiply_attention(self, x, attention, v=None):
    ...
    if mix_features:
        ...
        W = torch.sparse_coo_tensor(self.edge_index, new_attn, (x.shape[0], x.shape[0]), dtype=torch.float32,
